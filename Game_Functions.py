...
def update_bullets(ai_settings, screen,stats,sb, player, new_bullet, aliens, bosss, boss_bullet, enemyPlayer, extra_bullet):
    new_bullet.update()
...
def check_keydown_events(event, ai_settings, screen, player, bosss, new_bullet, boss_bullet, all_sprites, stats):
...
def fire_boss_bullet(ai_settings, screen, bosss, boss_bullet, all_sprites, player, pos, HPbar, extra_bullet):
...
def check_keyup_events(event, player, bosss, stats):
...
def check_events(ai_settings, screen, player, new_bullet, aliens, boss_bullet, bosss, all_sprites, pos, HPbar,
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.QUIT:
            ...
            check_keydown_events(event, ai_settings, screen, player, bosss, new_bullet, boss_bullet, all_sprites, stats)
        elif event.type == pygame.KEYUP:
            check_keyup_events(event, player, bosss, stats)
        elif event.type == bullet_event:
            fire_boss_bullet(ai_settings, screen, bosss, boss_bullet, all_sprites, player, pos, HPbar, extra_bullet)
...
def create_boss(ai_settings, screen, bosss, player, boss_bullet, all_sprites):
    bosik = boss(ai_settings, screen, bosss, player, boss_bullet, all_sprites)
    bosik_height = bosik.rect.height
    bosik.y = bosik_height
    bosik.rect.y = bosik.y
    bosss.add(bosik)
...
def update_aliens(ai_settings,stats,sb, screen, player, aliens, new_bullet, bosss, boss_bullet,extra_bullet, HPbar, explosion):
...
def create_bosss(ai_settings,screen,aliens, bosss, boss_bullet,new_bullet, extra_bullet, HPbar, player, explosion, stats):
...
def check_aliens_left(ai_settings, stats,sb, screen, player, aliens, new_bullet, bosss, boss_bullet, extra_bullet, HPbar, explosion):
